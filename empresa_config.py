...
class EmpresaConfig:
    ...
    def save_config(self, dados, logo_path=None):
        ...
        try:
            ...
            config_salva = self.get_config()
            if config_salva:
                return True
            else:
                raise Exception("Erro: Configuração não foi salva corretamente!")
        except Exception as e:
            raise Exception(f"Erro ao salvar configuração da empresa: {str(e)}")
